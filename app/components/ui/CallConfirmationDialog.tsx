    ...
    <>
      ...
      <div 
        className={`fixed inset-0 bg-black transition-opacity duration-300 z-[9998] ${
          animationState === 'entered' ? 'bg-opacity-75' : 'bg-opacity-0'
        }`}
      ...
      >
        <div 
          className={`relative bg-white w-full h-full transform transition-all duration-300 pointer-events-auto overflow-y-auto ${
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center min-h-screen p-6">
            ...
            <div className="text-center mb-8">
              <div className={`mx-auto w-20 h-20 bg-gradient-to-br ${getCallTypeColor()} rounded-full flex items-center justify-center mb-6 shadow-lg animate-pulse-orange`}>
                {getCallTypeIcon()}
              </div>
              <h2 id="dialog-title" className="text-2xl font-bold text-gray-900 mb-3">
                Confirm {getCallTypeText()}
              </h2>
              <p id="dialog-description" className="text-base text-gray-600">
                {callType === 'free' 
