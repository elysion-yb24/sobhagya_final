        ...
        <div className="bg-white" style={{ userSelect: 'text' }}>
          ...
          <div className="prose prose-lg max-w-none">
            <div className="space-y-8 text-gray-700 leading-relaxed select-text">
              ...
              {/* User's Consent */}
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">User's Consent</h2>
                <p>
              ...
              <div>
                ...
                <p>
                  <strong>Delete Profile:</strong> If you wish to delete your entire sobhagya profile, including personal information associated with it, you might find an option to "Delete your account" Click on this setting option in side menu and follow the instructions and complete the account deletion process.
                </p>
              </div>

              {/* Voice Recording and Microphone Permission */}
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Voice Recording and Microphone Permission</h2>
                <p>
                ...
                <p>
                  To enable you to record your questions and thoughts in your own voice as audio, we need to request access to your device's microphone. When you grant us this permission, it allows our app to capture the sound of your voice as audio and convert it into digital data that we can process.
                </p>
              </div>

              {/* Commitment */}
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Commitment</h2>
                <p>
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Information Collected by Website</h2>
                
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Personal Identifiable Information</h3>
                <p>
                ...
                <h4 className="text-lg font-medium text-gray-900 mb-2">Creating an Account / Registration Data</h4>
                <p>
                ...
                <h4 className="text-lg font-medium text-gray-900 mb-2">Booking a Paid Service</h4>
                <p>
                  While booking a service through Order Form, the personal information which may be sought would include, but not limited to the information as mentioned above, financial information inclusive of bank account information, credit card or debit card details or other payment instrument details through a secure third party gateway, IP (Internet protocol) Address and any other information that a User may provide during booking a paid service on the Website. Such information is kept highly confidential.
                </p>

                <h4 className="text-lg font-medium text-gray-900 mb-2">Log Files, IP Address and Cookies</h4>
                <p>
                ...
                <h4 className="text-lg font-medium text-gray-900 mb-2">Third-Party Platforms</h4>
                <p>
                ...
                <h4 className="text-lg font-medium text-gray-900 mb-2">User Feedback and Comments</h4>
                <p>
                ...
                <h4 className="text-lg font-medium text-gray-900 mb-2">Miscellaneous Activities</h4>
                <p>
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Non-Personal Identifiable Information</h3>
                <p>
              ...
              {/* User Representation */}
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">User Representation</h2>
                <p>
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Usage of the Information</h2>
                <p>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>For providing a personalised browsing experience. While guaranteeing the anonymity of the user, the personal information collected may be used for research purposes, for improving the marketing and promotional efforts, to analyse usage, improve the content of the Website, product offering and for customising the Website's layout for suiting the needs of its Users.</li>
                  <li>With IP tracking details and Cookies data, the Website will use it only for facilitating the usage of the website and provide personalised experience and any information which is sensitive in nature will not be provided to any third party without the consent of the User.</li>
                  <li>All information (and copies thereof) collected by Website, including without limitation Personal Information, User Data, and other information related to your access and use of the services offered by Website, may be retained by Website for such period as necessary, including but not limited to, for purposes such as compliance with statutory or legal obligations, tax laws and potential evidentiary purposes and for other reasonable purposes such as to implement, administer, and manage your access and use of our services, or resolution of any disputes.</li>
                </ul>
                <p>
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Children Privacy Policy</h2>
                <p>
              ...
              {/* Safety and Security */}
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Safety and Security</h2>
                <p>
                  Sobhagya.in honors users' privacy and employs the best practice to secure the user's personal details, such as birth details, address, etc., and also financial details such as credit card or debit card transaction details. Sobhagya.in uses the best encryption methodologies to ensure secure transactions from our side and thus encourages our clients to use their credit/debit cards on Sobhagya.in with full confidence. By doing so, we strive for the safety and security of our users, thus making their experience with Sobhagya.in absolutely safe and secure.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  For any queries or concerns regarding this Privacy Policy, please contact us at: <strong>info@sobhagya.in</strong>
                </p>
              </div>
