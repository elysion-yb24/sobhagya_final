          ...
          <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10 lg:gap-16">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <a href="/chat-app" className="flex items-center gap-x-3 text-white hover:text-[#F7971E] text-xs sm:text-sm lg:text-base transition-colors leading-none group">
                  <span className="inline-flex w-[14px] h-[14px] lg:w-[16px] lg:h-[16px] text-[#F7971E] text-[14px] lg:text-[16px] leading-none items-center justify-center flex-shrink-0 group-hover:text-[#F7971E]">◆</span>
            ...
            <div className="grid grid-cols-2 gap-3 xs:gap-5">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2.5 pt-0.5">
                  ...
                  <a href="/chat-app" className="flex items-center gap-2 py-1 text-white hover:text-[#F7971E] text-[13px] transition-all active:scale-95">
                    <span className="text-[#F7971E] text-[10px]">◆</span>
