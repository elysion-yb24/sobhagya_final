      ...
      <div className="hidden lg:block">
        <div className="max-w-8xl mx-auto px-4 lg:px-8">
          <div className="flex items-center h-20 justify-between">
            ...
            <Link href="/" className={`flex items-center gap-3 flex-shrink-0 min-w-[170px] justify-start transition-all duration-200 cursor-pointer ${isActiveLink('/') ? 'scale-105' : 'hover:scale-105'
              }`}>
              <Image
            ...
            <nav className="flex-1 flex items-center justify-center gap-6 lg:gap-8">
              ...
              >
                ...
                <span className={`absolute left-0 -bottom-1 w-full h-0.5 bg-gradient-to-r from-orange-400 to-orange-500 transition-transform origin-left duration-200 rounded-full ${(isActiveLink('/call-with-astrologer') || pathname === '/astrologers') ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
                  }`} />
              </Link>
              ...
              >
                ...
                <span className={`absolute left-0 -bottom-1 w-full h-0.5 bg-gradient-to-r from-orange-400 to-orange-500 transition-transform origin-left duration-200 rounded-full ${isActiveLink('/about') ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
                  }`} />
              </Link>
              ...
              >
                ...
                <span className={`absolute left-0 -bottom-1 w-full h-0.5 bg-gradient-to-r from-orange-400 to-orange-500 transition-transform origin-left duration-200 rounded-full ${isActiveLink('/services') ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
                  }`} />
              </Link>
              ...
              >
                ...
                <span className={`absolute left-0 -bottom-1 w-full h-0.5 bg-gradient-to-r from-orange-400 to-orange-500 transition-transform origin-left duration-200 rounded-full ${isActiveLink('/blog') ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
                  }`} />
              </Link>
      ...
      <div className="hidden md:block lg:hidden">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center h-16 justify-between">
            {/* Left: Logo/Brand */}
            <Link href="/" className={`flex items-center gap-2 flex-shrink-0 min-w-[140px] justify-start transition-all duration-200 cursor-pointer ${isActiveLink('/') ? 'scale-105' : 'hover:scale-105'
              }`}>
              <Image
                src="/sobhagya-logo.svg"
                alt="Sobhagya"
      ...
      {mounted && (
        <div className="md:hidden">
          <div className="flex items-center justify-between px-4 py-3">
            {/* Mobile Logo */}
            <Link href="/" className={`group flex items-center gap-2 transition-all duration-300 ${isActiveLink('/') ? 'scale-105' : 'hover:scale-105'
              }`}>
              <Image
                src="/sobhagya-logo.svg"
                alt="Sobhagya"
                  ...
                  <nav className="space-y-2">
                    {[
                      ...
                      >
                        ...
                        <div className={`transition-opacity duration-300 ${(isActiveLink(item.href) || (item.href === '/call-with-astrologer' && pathname === '/astrologers')) ? 'opacity-100 text-orange-500' : 'opacity-0 group-hover:opacity-100 text-orange-500'
                          }`}>
                          →
                        </div>
                      </Link>
