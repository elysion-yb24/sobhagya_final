...
export default function LiveSessionsPage() {
  ...
  return (
    <section className="bg-orange-50/30 w-full min-h-screen">
      {/* Top status bar — top offsets account for fixed header height incl. mobile quick-nav row */}
      <div className="sticky top-[88px] md:top-[64px] lg:top-[112px] z-30 bg-white/85 backdrop-blur-xl border-b border-orange-100 transition-all">
        <div className="max-w-6xl mx-auto px-3 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <h1 className="text-gray-900 font-bold text-lg sm:text-xl tracking-tight truncate">Live Sessions</h1>
            </div>
            {!isConnected && (
              <span className="flex items-center gap-1 text-[10px] text-red-500 bg-red-500/10 px-2 py-0.5 rounded-full shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 sm:px-4 py-2 rounded-full bg-white border border-orange-200 text-orange-600 hover:bg-orange-50 hover:border-orange-300 transition-all text-xs font-bold shadow-sm disabled:opacity-40 active:scale-95 shrink-0"
          >
