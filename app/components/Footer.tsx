  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main Footer Content - Logo + 4 Columns */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12">
          {/* Left Column - Logo + GET IN TOUCH */}
          ...
          {/* QUICK LINKS Column */}
          <div className="text-center space-y-4 mt-8 sm:mt-0">
            <h3 className="text-orange-400 font-semibold text-lg sm:text-xl mb-4">QUICK LINKS</h3>
            <div className="space-y-3">
              <Link
                href="/privacy-policy"
                className="flex items-center justify-center text-white hover:text-orange-400 text-sm sm:text-base transition-colors"
              >
