        ...
        {!isExiting && (
          ...
          >
            ...
            <motion.div
              ...
              className="flex justify-center gap-6 mb-24 mt-8"
            >
              {/* Date Dropdown */}
              <div className="relative">
                <select
                  ...
                  className="w-24 h-16 px-4 py-3 bg-white rounded-xl border-2 border-gray-200 
                           cursor-pointer focus:outline-none focus:ring-4 focus:ring-orange-100 
                           focus:border-[#F7971D] text-lg font-medium text-gray-700
