  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="text-left lg:text-center space-y-4 sm:space-y-5">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              {/* Socials under Get in touch */}
              <div className="flex items-center justify-start lg:justify-center space-x-4 sm:space-x-5 pt-2">
                <Link
          ...
          <div className="text-left lg:text-center space-y-4 sm:space-y-5">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <Link
                href="/terms"
                className="flex items-center justify-end lg:justify-center text-white hover:text-orange-400 text-sm sm:text-base transition-colors"
              >
        ...
        {/* Footer Bottom with Logo and Text inline */}
